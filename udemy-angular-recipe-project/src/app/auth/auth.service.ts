...
export class AuthService {
    ...
    constructor(private http: HttpClient, private router: Router, private enviroment: Enviroment) {}
    ...
    login(email: string, password: string) {
        return this.http.post<AuthResponseData>(
            "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=" + this.enviroment.apiKey, 
            {
                email: email,
                password: password,
                returnSecureToken: true
